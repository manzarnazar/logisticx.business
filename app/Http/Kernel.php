...
use App\Http\Middleware\ModifyHeaderMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\TrackUserRouteAccess::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'isNotInstalled'    => \Modules\Installer\Http\Middleware\IsNotInstalledMiddleware::class,
        'isInstalled'       => \Modules\Installer\Http\Middleware\IsInstalledMiddleware::class
    ];
}
