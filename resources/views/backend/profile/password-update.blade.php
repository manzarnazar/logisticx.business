        ...
        <form action="{{route('password.update')}}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-12">
                    <label class=" label-style-1" for="old_password">{{ ___('label.old_password') }}<span class="text-danger">*</span> </label>
                ...
                <div class="form-group col-md-12">
                    <label class=" label-style-1" for="new_password">{{ ___('label.new_password') }}<span class="text-danger">*</span> </label>
                ...
                <div class="form-group col-md-12">
                    <label class=" label-style-1" for="confirm_password">{{ ___('label.confirm_password') }}<span class="text-danger">*</span> </label>
