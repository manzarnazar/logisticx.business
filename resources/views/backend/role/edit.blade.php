                            ...
                            <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="status" class="form-control input-style-1 select2">
                                        ...
                                        <option value="{{ $key }}" {{ (old('status',$role->status) == $key) ? 'selected' : '' }}>{{ ___('common.'.  $status) }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="row align-items-start permission-check-box pb-2 pt-2">
                                                    <input id="{{ $keyword }}" class="read common-key mr-2" type="checkbox" value="{{ $keyword }}" name="permissions[]" @if($role->permissions !==null && in_array($keyword,$role->permissions)) checked @endif />
