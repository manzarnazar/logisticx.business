                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('support.index')}}" class="breadcrumb-link">{{ ___('common.support_list') }}</a></li>
                    ...
                    <div class="mx-3 collapse @error('message') show @enderror" id="collapseOne" data-parent="#accordion">
                        ...
                        <form action="{{ route('support.reply',['support_id'=>$singleSupport->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div> <button type="submit" class="j-td-btn">{{ ___('label.send') }}</button></div>
                            </div>
