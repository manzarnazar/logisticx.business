...
@section('title')
{{ ___('label.home_page_slider') }} {{ ___('label.create') }}
@endsection
...
<div class="container-fluid  dashboard-content">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('HomePageSider.index') }}" class="breadcrumb-link">{{ ___('label.home_page_slider') }}</a>
                            </li>
    ...
    <div class="j-create-main">
        <form action="{{ route('HomePageSider.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="form-inputs">
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.create') }} {{ ___('label.home_page_slider') }}</h4>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                <label class="label-style-1">{{ ___('label.small_title') }} <span class="text-danger">*</span></label>
                                <input type="text" placeholder="{{ ___('label.enter_small_title') }}" class="form-control input-style-1" name="small_title" value="{{ old('small_title') }}">
                                @error('small_title')
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" placeholder="{{ ___('label.description') }}" class="form-control input-style-1" name="description" value="{{ old('description') }}">
                                @error('description')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="url" placeholder="{{ ___('label.enter_page_link') }}" class="form-control input-style-1" name="page_link" value="{{ old('page_link') }}">
                                @error('page_link')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="url" placeholder="{{ ___('label.enter_video_link') }}" class="form-control input-style-1" name="video_link" value="{{ old('video_link') }}">
                                @error('video_link')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
                              <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control input-style-1 dateofbirth" name="date" readonly value="{{ old('date', Date('d/m/Y')) }}">
            ...
            <div class="j-create-btns">
                <div class="drp-btns">
                    ...
                    <a href="{{ route('HomePageSider.index') }}" class="j-td-btn btn-red"> <i class="fa-solid fa-rectangle-xmark"></i><span>{{ ___('label.cancel') }}</span> </a>
                </div>
            </div>
        </form>
    </div>
