...
@section('title')
{{ ___('account.hub_payment_request') }} {{ ___('label.add') }}
@endsection
@section('maincontent')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('account.submit_request') }}</h4>
                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select id="hub_account_id" name="hub_account_id" class="form-control input-style-1 select2" data-url="{{ route('accounts.searchByHub') }}">
                                    ...
                                    <option value="{{ $account->id }}" @selected(old('hub_account_id')==$account->id)>{{ @$account->text }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input id="amount" type="number" step="any" name="amount" placeholder="{{___('placeholder.amount')}}" autocomplete="off" class="form-control input-style-1" value="{{old('amount')}}" require>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description" class="form-control input-style-1" placeholder="{{___('placeholder.enter_description')}}" require>{{ old('description') }}</textarea>
                                @error('description')
