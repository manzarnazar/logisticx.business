...
@section('title')
{{ ___('common.designation') }} {{ ___('label.edit') }}
@endsection
@section('maincontent')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('designations') }}" class="breadcrumb-link">{{ ___('common.designation') }}</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-input-header">
                        <h4 class="title-site">{{___('label.edit')}} {{ ___('label.designation') }}</h4>
                    </div>
                    <form action="{{route('designations.update',['id'=>$designation->id])}}" method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input id="title" type="text" name="title" data-parsley-trigger="change" placeholder="{{ ___('placeholder.enter_title') }}" autocomplete="off" class="form-control input-style-1" value="{{old('title',$designation->title)}}" require>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select name="status" class="form-control input-style-1 select2">
                                    ...
                                    <option value="{{ $key }}" {{ (old('status',$designation->status) == $key) ? 'selected' : '' }}>{{ ___('common.'.  $status) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="j-create-btns">
                            <div class="drp-btns">
                                ...
                                <a href="{{ route('designations') }}" class="j-td-btn btn-red"> <i class="fa-solid fa-rectangle-xmark "></i><span>{{ ___('label.cancel') }}</span> </a>
                            </div>
                        </div>
                    </form>
                </div>
