...
@section('title')
{{ ___('common.designation') }} {{ ___('label.add') }}
@endsection
@section('maincontent')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('label.create') }} {{ ___('label.designation') }}</h4>
                    </div>
                    ...
                    <form action="{{route('designations.store')}}" method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input id="title" type="text" name="title" data-parsley-trigger="change" placeholder="{{ ___('placeholder.enter_title') }}" autocomplete="off" class="form-control input-style-1" value="{{old('title')}}" require>
                                @error('title')
