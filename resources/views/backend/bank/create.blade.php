            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('label.bank_create') }}</h4>
                    </div>

                    <form action="{{route('banks.store')}}" method="POST" enctype="multipart/form-data" id="basicform">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label class="label-style-1">{{ ___('label.bank_name') }} <span class="text-danger">*</span></label>
                                <input type="text" placeholder="{{ ___('label.enter_bank_name') }}" class="form-control input-style-1" name="bank_name" value="{{ old('bank_name') }}">
