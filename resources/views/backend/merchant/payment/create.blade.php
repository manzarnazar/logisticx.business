                ...
                <div class="card-body">
                    ...
                    <form action="{{route('merchant.payment.account.store')}}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6 bank-input d-none ">
                                <label class="label-style-1" for="routing_no">{{ ___('merchant.routing_number') }}.<span class="text-danger">*</span> </label>
                            ...
                            {{-- Bank Account type --}}
                            <div class="form-group col-12 col-md-6 bank-input d-none">
                                <label class="label-style-1" for="bank_account_type">{{ ___('merchant.account_type') }}<span class="text-danger">*</span> </label>
                            ...
                            {{-- MFS Account type --}}
                            <div class="form-group col-12 col-md-6 mfs-input d-none">
                                <label class="label-style-1" for="mfs_account_type">{{ ___('merchant.account_type') }}<span class="text-danger">*</span> </label>
