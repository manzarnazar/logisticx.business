        ...
        <div class="col-md-8 col-lg-12 col-xl-9">
            <div class="card">
                ...
                <div class="card-header mb-3">
                    ...
                    <a href="{{ route('merchant.paymentInfo.add',$merchant_id) }}" class="j-td-btn">
                            ...
                            <tr id="row_{{ $account->id }}">
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="{{route('merchant.paymentInfo.edit',[$account->merchant_id,$account->id])}}" class="dropdown-item"><i class="fa fa-edit" aria-hidden="true"></i> {{ ___('label.edit') }}</a>
                                        @endif
                                        @if( hasPermission('merchant_payment_account_delete') )
                                        <a class="dropdown-item" href="javascript:void(0);" onclick="delete_row('merchant/payment/account/delete', {{$account->id}})">
