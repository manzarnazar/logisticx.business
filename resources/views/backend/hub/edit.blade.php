    ...
    <div class="card">
        <div class="card-body">
            <div class="form-input-header">
                <h4 class="title-site"> {{ ___('hub.edit_hub') }}</h4>
            </div>
            <form action="{{route('hubs.update',['id'=>$hub->id])}}" method="POST" enctype="multipart/form-data" id="basicform">
                ...
                <div class="form-row">
                    <div class="col-lg-6 col-12 form-group">
                        ...
                        <input id="name" type="text" name="name" data-parsley-trigger="change" placeholder="{{ ___('placeholder.name') }}" class="form-control input-style-1 " value="{{$hub->name}}" @required(true) autocomplete="off">
                    ...
                    <div class="col-lg-6 col-12 form-group">
                        ...
                        <input id="phone" type="tel" name="phone" data-parsley-trigger="change" placeholder="{{ ___('placeholder.enter_phone') }}" class="form-control input-style-1 " value="{{$hub->phone}}" @required(true) autocomplete="off">
                    ...
                    <div class="col-lg-6 col-12 form-group">
                        ...
                        <select name="coverage" id="coverage" class="form-control input-style-1  select2">
                            ...
                            <option value="{{ $coverage->id}}" @selected(old('coverage',$hub->coverage_id)==$coverage->id)> {{ $coverage->name }}</option>

                            <x-coverage-child :coverage="$coverage" :old="$hub->coverage_id" name="coverage" />
                    ...
                    <div class="col-lg-6 col-12 form-group">
                        ...
                        <select name="status" class="form-control input-style-1  select2">
                            ...
                            <option value="{{ $key }}" @selected(old('status',$hub->status) == $key)>{{ ___('common.'.  $status) }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-6 col-12 form-group">
                        ...
                        <textarea name="address" id="address" class="form-control input-style-1 " rows="4" placeholder="{{ ___('placeholder.address') }}">{{ old('address',$hub->address)  }}</textarea>
