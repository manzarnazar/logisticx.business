...
@section('title')
{{ ___('charges.product_category') }} {{ ___('label.update') }}
@endsection
@section('maincontent')
<!-- wrapper  -->
<div class="container-fluid  dashboard-content">
    ...
    <div class="card">
        <div class="form-input-header">
            <h4 class="title-site"> {{ ___('label.update') }} {{ ___('charges.product_category') }} </h4>
        </div>
        <div class="card-body">
            <form action="{{route('productCategory.update')}}" method="POST" enctype="multipart/form-data" id="basicform">
                @csrf
                @method('put')
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control input-style-1 " id="name" type="text" name="name" value="{{old('name') ?? $category->name }}" placeholder="Enter Product Category name" autocomplete="off">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control input-style-1 " id="position" name="position" value="{{ old('position') ?? ($category->position != 0 ? $category->position : 0) }}" placeholder="Position" autocomplete="off">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-select input-style-1 select2" name="status" id="status">
                            ...
                            <option value="0" @if($category->status=="0" || old('status')=="0" ) selected @endif>{{___('label.inactive')}}</option>
                        </select>
                ...
                <div class="j-create-btns mt-2">
                    <div class="drp-btns">
                        ...
                        <a href="{{ route('productCategory') }}" class="j-td-btn btn-red"> <i class="fa-solid fa-rectangle-xmark "></i><span>{{ ___('label.cancel') }}</span> </a>
                    </div>
                </div>
