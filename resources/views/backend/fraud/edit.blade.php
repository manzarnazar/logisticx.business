            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('menus.fraud_edit') }}</h4>
                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="details" id="details" class="form-control input-style-1">{{old('details',$fraud->details)}}</textarea>
