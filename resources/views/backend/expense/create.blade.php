            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('account.create_expense') }}</h4>
                    </div>

                    <form action="{{route('expense.store')}}" method="POST" enctype="multipart/form-data" id="expenseForm">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="account_head_id" name="account_head_id" class="form-control input-style-1 select2" required>
                                    ...
                                    @if($account_head->id != \App\Enums\FixedAccountHeads::PaidToMerchant && $account_head->id != \App\Enums\FixedAccountHeads::PaidToAdmin)
                                    <option value="{{ $account_head->id }}" @selected(old('account_head_id')==$account_head->id) >{{ $account_head->name}}</option>
                                    @endif
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6 inputs-other d-none">
                                ...
                                <input id="title" type="text" name="title" data-parsley-trigger="change" placeholder="{{ ___('placeholder.enter_title') }}" class="form-control input-style-1" value="{{ old('title') }}" require>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" step="any" class="form-control input-style-1" id="amount" name="amount" value="{{ old('amount') }}" placeholder="{{ ___('placeholder.enter_Amount') }}" readonly>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control input-style-1" id="note" name="note"></textarea>
