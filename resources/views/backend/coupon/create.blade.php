...
@section('title')
{{ ___('menus.coupon') }} {{ ___('label.add') }}
@endsection
@section('maincontent')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('label.add') }} {{ ___('menus.coupon') }} </h4>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="type" id="type" class="form-control input-style-1 select2" data-merchant="{{ App\Enums\CouponType::MERCHANT_WISE->value }}" data-placeholder="{{ ___('placeholder.coupon_type') }}">
                                    ...
                                    <option value="{{ $key }}" @selected(old('type')==$key)> {{ ___('common.'. $type  ) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 col-md-6 form-group merchant_container">
                                ...
                                <select name="merchant_id[]" id="merchant_id" class="form-control input-style-1 select2" data-url="{{ route('parcel.merchant.get') }}" multiple @disabled(true)>
                                    <option></option>
                                </select>
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input id="start_date" type="date" name="start_date" placeholder="{{ ___('placeholder.start_date') }}" class="form-control input-style-1 flatpickr" value="{{ old('start_date') }}" />
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input id="end_date" type="date" name="end_date" placeholder="{{ ___('placeholder.end_date') }}" class="form-control input-style-1 flatpickr" value="{{old('end_date')}}" />
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <select name="discount_type" id="discount_type" class="form-control input-style-1 select2" data-placeholder="{{ ___('placeholder.discount_type') }}">
                                    ...
                                    <option value="{{ $key }}" @selected(old('discount_type')==$key)> {{ ___('common.'. $type  ) }}</option>
                                    @endforeach
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input type="number" step="any" name="discount" id="discount" class="form-control input-style-1" value="{{old('discount')}}" placeholder="{{ ___('placeholder.amount') }}" />
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input type="text" name="coupon" id="coupon" class="form-control input-style-1" value="{{ old('coupon') }}" placeholder="{{ ___('placeholder.coupon_code') }}" oninput="this.value = this.value.replace(/\s+/g, '').toUpperCase();" />
