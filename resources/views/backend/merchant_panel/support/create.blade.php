                    ...
                    <form action="{{route('merchant-panel.support.store')}}" method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="subject" type="text" name="subject" placeholder="{{ ___('placeholder.enter_Subject') }}" autocomplete="off" class="form-control input-style-1" value="{{old('subject')}}" require>
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <select name="service" class="form-control input-style-1 select2" id="service">
                                    ...
                                    <option value="{{ $service }}" @selected(old('service')==$service)>{{ ___('common.'.$service) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="priority" class="form-control input-style-1 select2" id="priority">
                                    ...
                                    <option value="{{ $priority }}" @selected(old('priority')==$priority)>{{ ___('label.'.$priority) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="date" type="date" name="date" class="form-control input-style-1 flatpickr" value="{{old('date',date('Y-m-d'))}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description" id="description" class="form-control input-style-1 summernote" rows="3" placeholder="{{ ___('placeholder.enter_description') }}">{{ old('description') }}</textarea>
