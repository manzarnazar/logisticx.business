...
<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h2 class="pageheader-title">{{ ___('fraud.create_fraud') }}</h2>
                    <form action="{{route('merchant-panel.fraud.store')}}" method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input id="name" type="text" name="name" data-parsley-trigger="change" placeholder="{{ ___('placeholder.name') }}" autocomplete="off" class="form-control input-style-1" value="{{old('name')}}" require>
                                @error('name')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input id="tracking_id" type="text" name="tracking_id" data-parsley-trigger="change" placeholder="{{ ___('placeholder.enter_tracking_id') }}" autocomplete="off" class="form-control input-style-1" value="{{old('tracking_id')}}">
                            </div>

                            <div class="form-group col-12 col-md-6">
                                <label class="label-style-1" for="details">{{ ___('label.details') }}<span class="text-danger">*</span> </label>
                                <textarea name="details" id="details" class="form-control input-style-1" rows="6"></textarea>
                            </div>
                        </div>
