                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-12  ">
                            <label class="label-style-1" for="returnassigntomerchantReschedule">{{ ___('parcel.delivery_man') }}</label>
                            <span class="text-danger">*</span>
                            <select id="returnassigntomerchantReschedule" class="form-control input-style-1 delivery_man_search" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}">
                                <option value=""></option>
                            </select>
