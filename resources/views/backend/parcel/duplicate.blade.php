...
@section('title')
{{ ___('parcel.parcel') }} {{ ___('label.duplicate') }}
@endsection
@section('maincontent')
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="" class="breadcrumb-link active">{{ ___('label.duplicate') }}</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-8">
                <div class="form-inputs">
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('parcel.duplicate') }} </h4>
                    </div>
                    <form action="{{route('parcel.store')}}" method="POST" enctype="multipart/form-data" id="parcelForm">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6  @if(auth()->user()->user_type == \App\Enums\UserType::MERCHANT) d-none @endif">
                                ...
                                <select id="merchant_id" name="merchant_id" class="form-control input-style-1" data-url="{{ route('parcel.merchant.get') }}">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <select id="shop_id" class="form-control input-style-1" name="shop_id" data-url="{{ route('parcel.merchant.shops') }}">
                                    <option></option>
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="text" name="pickup_phone" id="pickup_phone" class="form-control input-style-1" value="{{old('pickup_phone',$parcel->pickup_phone)}}" placeholder="{{ ___('label.pickup') }} {{ ___('label.phone') }}" autocomplete="off">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input id="pickup_address" type="text" name="pickup_address" placeholder="{{ ___('label.pickup') }} {{ ___('label.address') }}" autocomplete="off" class="form-control input-style-1" value="{{old('pickup_address',$parcel->pickup_address)}}">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="number" step="any" class="form-control input-style-1" id="cash_collection" name="cash_collection" value="{{ old('cash_collection',$parcel->parcelTransaction->cash_collection) }}" placeholder="{{ ___('parcel.Cash_amount_including_delivery_charge') }}" onblur="this.value=this.value < 1 ? 0 : this.value">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="number" step="any" class="form-control input-style-1" id="selling_price" name="selling_price" value="{{ old('selling_price',$parcel->parcelTransaction->selling_price) }}" placeholder="{{ ___('parcel.Selling_price_of_parcel') }}" onblur="this.value=this.value < 1 ? 0 : this.value">
                                <small class="text-danger errorTextBox d-none mt-2" data-error-for="selling_price"></small>
                            </div>

                            <div class="form-group col-12 col-md-6">
                                <label class="label-style-1" for="invoice_no">{{ ___('parcel.invoice')}} <span class="text-danger">*</span> </label>
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="text" name="customer_phone" id="customer_phone" class="form-control input-style-1" value="{{old('customer_phone',$parcel->customer_phone)}}" placeholder="{{ ___('label.customer_phone') }}" autocomplete="off">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="destination" id="destination" class="form-control input-style-1 select2">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-6">
                                ...
                                <textarea id="customer_address" name="customer_address" class="form-control input-style-1" rows="5">{{ old('customer_address',$parcel->customer_address) }}</textarea>
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <textarea id="note" name="note" class="form-control input-style-1" rows="5">{{ old('note',$parcel->note) }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="fragileLiquid">{{ ___('parcel.liquid_fragile') }}</label>
                            ...
                            <div class="form-group col-md-6" id="vasDiv">
                                ...
                                <select name="vas[]" id="vas" class="form-control  input-style-1" multiple data-vas-charge="{{ $parcel->parcelTransaction->vas_charge}}">
                                    <option></option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="service_type" id="service_type" class="form-control input-style-1" data-url="{{ route('parcel.serviceType') }}">
                                    <option></option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" id="quantity" name="quantity" class="form-control input-style-1" value="{{ old('quantity',$parcel->quantity)}}" placeholder="{{ ___('parcel.quantity') }}" oninput="this.value=this.value < 1 ? 1 : this.value" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="coupon" id="coupon" class="form-control input-style-1" value="{{ old('coupon') }}" placeholder="Enter Coupon" oninput="this.value = this.value.replace(/\s+/g, '').toUpperCase();" data-url="{{ route('coupon.apply') }}" />
                                    <span id="couponApply" class="input-group-text btn btn-light">{{ ___('label.Apply') }}</span>
                                </div>
