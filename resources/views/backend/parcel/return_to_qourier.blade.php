<div class="modal fade" id="parcelstatus{{ \App\Enums\ParcelStatus::RETURN_TO_COURIER }}" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="data-modal">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ ___('parcel.return_to_courier') }}</h5>
