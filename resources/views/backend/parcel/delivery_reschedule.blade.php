    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" id="data-modal">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ ___('parcel.delivery_re_schedule') }}</h5>
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-12">
                            <label class="label-style-1" for="deliverymanreschedule">{{ ___('parcel.parcel') }}</label> <span class="text-danger">*</span>
                            <select id="deliverymanreschedule" class="form-control input-style-1 select2 deliverymanreschedule" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}">
                                <option value=""></option>
                            </select>
                        ...
                        <div class="form-group col-12 pt-1">
                            ...
                            <input type="date" id="date" data-toggle="datepicker" name="date" placeholder="Select date" class="form-control input-style-1 flatpickr" value="{{ old('date') }}" required>
                            @error('date')
                            <small class="text-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>
