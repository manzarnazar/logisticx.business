...
@section('title')
    {{ ___('hub.incharge') }} {{ ___('label.edit') }}
@endsection
@section('maincontent')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.edit') }} {{ $hub->name }} {{ ___('hub.incharge') }} </h4>
                        </div>

                        <form action="{{ route('hub-incharge.update', [$hub->id, $inCharge]) }}" method="POST" enctype="multipart/form-data"
                            id="basicform">
                            @csrf
                            @method('PUT')
                            <div class="row">
