...
@section('title')
{{ ___('menus.app_slider') }} {{ ___('label.add') }}
@endsection
@section('maincontent')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('label.add') }} {{ ___('menus.app_slider') }} </h4>
                    </div>

                    <form action="{{route('app_slider.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-row">
                            <div class="col-md-6 form-group">
                                ...
                                <input id="title" type="text" name="title" placeholder="{{ ___('placeholder.title') }}" class="form-control input-style-1" value="{{ old('title') }}" />
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="ot_fileUploader left-side">
                                    ...
                                    <button class="primary-btn-small-input" type="button" fdprocessedid="64bjqb">
                                        ...
                                        <input type="file" class="d-none form-control" name="image" id="fileBrouse" accept="image/jpeg, image/jpg, image/png, image/webp, file/pdf" style="display: none;">
                                    </button>
                                </div>
                            </div>
                            <div class="col-12 form-group">
                                <label class=" label-style-1" for="descriptions">{{ ___('label.description')}}</label>
                                <textarea class="form-control input-style-1" name="description" id="descriptions" placeholder="{{ ___('placeholder.enter_description') }}">{{ old('description') }}</textarea>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input id="position" type="number" name="position" placeholder="{{ ___('placeholder.position') }}" class="form-control input-style-1" value="{{old('position')}}" />
