        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="top-box-wrp-1">
                    <div class=" top-box">
                        <ul class="top-adss">
                            <li> <i> <img src="{{asset('frontend')}}/assets/img/icon/icon-top-1-wh.png" alt="no image"> </i> <span>{{ settings('phone') }}</span> </li>
                            <li> <i> <img src="{{asset('frontend')}}/assets/img/icon/icon-top-2-wh.png" alt="no image"> </i> <span>{{ settings('email') }}</span> </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar navbar-expand-lg bsnav bsnav-sticky bsnav-sticky-slide">
                <div class="container">
                    ...
                    <div class="search-cart nav-profile">
                        <a href="{{route('frontend.signin')}}" class="btn-1 btn-border btn-sm">Sign In</a>
                        <a href="{{route('frontend.signup')}}" class="btn-1 btn-sm">Sign Up</a>
                    </div>
