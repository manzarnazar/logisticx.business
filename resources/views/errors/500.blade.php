...
@section('title',___('alert.internal_server_error'))
            ...
            <div class="d-flex">
                ...
                <div class="d-flex align-items-center">
                    <div class="page-not-righ-ele">
                        <h2 class="headin-1">500</h2>
                        <h4 class="heading-4">{{___('alert.internal_server_error')}}</h4>
                        <p class="mb-40">{{___('alert.message_500')}}</p>
