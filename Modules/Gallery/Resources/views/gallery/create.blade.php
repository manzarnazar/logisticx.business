...
@section('title')
{{ ___('label.gallery') }} {{ ___('label.create') }}
@endsection
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('gallery.index') }}" class="breadcrumb-link">{{ ___('label.gallerys') }}</a>
                            </li>
        ...
        <form action="{{ route('gallery.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    <div class="form-inputs">
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.create') }} {{ ___('label.gallery') }}</h4>
                        </div>
            ...
            <div class="j-create-btns">
                <div class="drp-btns">
                    ...
                    <a href="{{ route('gallery.index') }}" class="j-td-btn btn-red"> <i class="fa-solid fa-rectangle-xmark"></i><span>{{ ___('label.cancel') }}</span> </a>
                </div>
            </div>
        </form>
    </div>
