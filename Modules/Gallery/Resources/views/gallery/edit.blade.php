                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('gallery.index') }}" class="breadcrumb-link">{{ ___('label.galleries') }}</a></li>
                ...
                <div class="col-12">
                    <div class="form-inputs">
                        ...
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.edit') }} {{ ___('label.gallery') }}</h4>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" placeholder="{{ ___('label.enter_title') }}" class="form-control input-style-1" name="title" value="{{ old('title', $gallery->title) }}">
                                @error('title')
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" placeholder="{{ ___('placeholder.position') }}" class="form-control input-style-1" name="position" value="{{ old('position', $gallery->position) }}">
                                @error('position')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="status" class="form-control input-style-1 select2">
                                    ...
                                    <option value="{{ $key }}" @selected(old('status', $gallery->status) == $key)>{{ ___('common.'.  $status) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="ot_fileUploader left-side mb-3">
                                    <img src="{{ getImage($gallery->upload, 'original','default-image-40x40.png') }}">
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control" rows="8" name="short_description" placeholder="{{ ___('placeholder.short_description') }}" > {{ old('title', $gallery->short_description) }} </textarea>
                                @error('description')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
            ...
            <div class="form-row">
                <div class="j-create-btns ml-1">
                    <div class="drp-btns">
                        ...
                        <a href="{{ route('gallery.index') }}" class="j-td-btn btn-red">
