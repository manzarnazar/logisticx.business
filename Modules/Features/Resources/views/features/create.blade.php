...
@section('title')
{{ ___('label.features') }} {{ ___('label.create') }}
@endsection
                ...
                <div class="col-12">
                    <div class="form-inputs">
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.create') }} {{ ___('label.features') }}</h4>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control input-style-1 summernote" name="description" id="summernote"></textarea>
                                @error('description')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
