            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-input-header">
                        <h4 class="title-site">{{ ___('label.edit') }} {{ ___('language.title') }}</h4>
                    </div>
                    ...
                    <form action="{{route('language.update')}}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" name="name" id="name" class="form-control input-style-1" value="{{ old('name',$lang->name) }}" placeholder="{{ ___('placeholder.enter_name') }}">
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" name="code" id="code" class="form-control input-style-1" value="{{ old('code',$lang->code) }}" placeholder="{{ ___('placeholder.enter_language_code') }}">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="status" class="form-control input-style-1 select2">
                                    ...
                                    <option value="{{ $key }}" @selected(old('status', $lang->status) == $key)>{{ ___('common.'.  $status) }}</option>
                                    @endforeach
                                </select>
