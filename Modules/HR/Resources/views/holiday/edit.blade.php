...
@section('title')
{{ ___('menus.holiday') }} {{ ___('label.update') }}
@endsection
@section('maincontent')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-input-header">
                        <h4 class="title-site"> {{ ___('label.update') }} {{ ___('menus.holiday') }} </h4>
                    </div>

                    <form action="{{route('holiday.update')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="title" id="title" class="form-control input-style-1" value="{{ old('title',@$holiday->title) }}" placeholder="{{ ___('placeholder.enter_title') }}">
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input id="days" type="date" name="days" placeholder="{{ ___('placeholder.select_holiday_duration') }}" class="form-control input-style-1 flatpickr-range" value="{{ old('days',@$holiday->days) }}" />
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <textarea name="description" id="description" class="form-control input-style-1" placeholder="{{ ___('placeholder.enter_description')}}">{{ old('description',@$holiday->description) }}</textarea>
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <select name="status" class="form-control input-style-1 select2">
                                    ...
                                    <option value="{{ $key }}" @selected(old('status',@$holiday->status)==$key)>{{ ___('common.'.  $status) }}</option>
                                    @endforeach
                                </select>
