...
@section('title')
    {{ ___('label.social_link') }} {{ ___('label.create') }}
@endsection
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="javascript:void(0)" class="active">{{ ___('label.create') }}</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="form-input-header">
                        <h4 class="title-site">{{ ___('label.create') }} {{ ___('label.social_link') }}
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('socialLink.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group ">
                                        <label class="label-style-1">{{ ___('label.icon') }} ({{___('label.example')}}: <span class="text-warning">fab
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="status" class="form-control input-style-1 select2">
                                        <option value="{{ \App\Enums\Status::ACTIVE }}">{{ ___('label.active') }} </option>
                            ...
                            <div class="form-row ">
                                <div class="j-create-btns ml-1">
                                    <div class="drp-btns">
                                        ...
                                        <a href="{{ route('socialLink.index') }}" class="j-td-btn btn-red">
