...
<div class="container-fluid  dashboard-content">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('delivery_area.index') }}" class="breadcrumb-link">{{ ___('label.delivery_areas') }}</a></li>
    ...
    <div class="j-create-main">
        <form action="{{ route('delivery_area.update', [$delivery_area->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-12">
                    <div class="form-inputs">
                        ...
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.edit') }} {{ ___('label.delivery_area') }}</h4>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" placeholder="{{ ___('label.enter_title') }}" class="form-control input-style-1" name="title" value="{{ old('title', $delivery_area->title) }}">
                                @error('title')
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" placeholder="{{ ___('placeholder.position') }}" class="form-control input-style-1" name="position" value="{{ old('position', $delivery_area->position) }}">
                                @error('position')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="status" class="form-control input-style-1 select2">
                                    ...
                                    <option value="{{ $key }}" @selected(old('status', $delivery_area->status) == $key)>{{ ___('common.'.  $status) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="ot_fileUploader left-side mb-3">
                                    <img src="{{ getImage($delivery_area->upload, 'original','default-image-40x40.png') }}">
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control input-style-1 " name="short_description" placeholder="{{ ___('placeholder.short_description') }}" > {{ old('title', $delivery_area->short_description) }} </textarea>
                                @error('description')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
            ...
            <div class="form-row">
                <div class="j-create-btns ml-1">
                    <div class="drp-btns">
                        ...
                        <a href="{{ route('delivery_area.index') }}" class="j-td-btn btn-red">
