...
@section('title')
{{ ___('label.delivery_area') }} {{ ___('label.create') }}
@endsection
...
<div class="container-fluid  dashboard-content">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('delivery_area.index') }}" class="breadcrumb-link">{{ ___('label.delivery_areas') }}</a>
                            </li>
    ...
    <div class="j-create-main">
        <form action="{{ route('delivery_area.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="form-inputs">
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.create') }} {{ ___('label.delivery_area') }}</h4>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control input-style-1 " name="short_description" placeholder="{{ ___('placeholder.short_description') }}"></textarea>
            ...
            <div class="j-create-btns">
                <div class="drp-btns">
                    ...
                    <a href="{{ route('delivery_area.index') }}" class="j-td-btn btn-red"> <i class="fa-solid fa-rectangle-xmark"></i><span>{{ ___('label.cancel') }}</span> </a>
                </div>
            </div>
        </form>
    </div>
