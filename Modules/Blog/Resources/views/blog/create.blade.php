...
@section('title')
{{ ___('label.blog') }} {{ ___('label.create') }}
@endsection
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('blog.index') }}" class="breadcrumb-link">{{ ___('label.blogs') }}</a>
                            </li>
        ...
        <form action="{{ route('blog.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    <div class="form-inputs">
                        <div class="form-input-header">
                            <h4 class="title-site"> {{ ___('label.create') }} {{ ___('label.blog') }}</h4>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="author" class="form-control input-style-1 select2">
                                    <option selected disabled>{{ ___('label.select') }} {{ ___('label.author') }} </option>
                                    @foreach ($users as $user)
                                    <option value="{{ $user->id }}" @selected(old('author')==$user->id)>{{ $user->name }}</option>
                                    @endforeach
                                </select>
                                @error('author')
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control input-style-1 summernote" name="description" id="summernote" placeholder="{{ ___('placeholder.blog_description') }}"></textarea>
            ...
            <div class="j-create-btns">
                <div class="drp-btns">
                    ...
                    <a href="{{ route('blog.index') }}" class="j-td-btn btn-red"> <i class="fa-solid fa-rectangle-xmark"></i><span>{{ ___('label.cancel') }}</span> </a>
                </div>
            </div>
        </form>
    </div>
