...
<div class="col-lg-6  {{ widgetArray()["here_is_my_full_resume"] }}" >
    <div class="form-group ">
        <label>{{ ___('title') }} <span class="text-danger">*</span></label>
        <input type="text" placeholder="{{ ___('enter_title') }}"  class="form-control"  value="{{ old('title',$widget->value['title']?? '') }}" name="title" />
        @error('title')
